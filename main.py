...
# Студенты
student_1 = Student('Илья', 'Ежиков', 'Муж')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ["Введение в програмирование"]

student_2 = Student('Валерия', 'Коблик', 'Жен')
student_2.courses_in_progress += ['Python']
student_2.finished_courses += ["Введение в програмирование"]

# Лекторы
lecturer_1 = Lecturer('Владислав', 'Пушкин')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Ольга', 'Ушакова')
...
reviewer_2 = Reviewer('София', 'Волковая')
...
student_2.rate_lw(lecturer_2, 'Python', 5)
...
def average_rating_for_course(course, student_list):
    ...
    for stud in student_list:
        for course in stud.grades:
            stud_sum_rating = stud.avg_rating_for_course(course)
